...
class Lock(models.Model):
    """
    Representa una cerradura física vinculada al sistema.
    """
    name = models.CharField(max_length=100)
    uuid = models.CharField(max_length=100, unique=True)  # Identificador único de hardware (ESP32)
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='owned_locks')
